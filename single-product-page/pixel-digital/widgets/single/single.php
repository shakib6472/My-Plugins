                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="one-four-block">
                                ...
                                <div class="product-price">
                                    <?php if ($sale_price) { ?>
                                        <span class="sale-price"><?php echo $sale_price . ' টাকা' ?></span>
                                        <span class="offer" style="color: #ed1c24;"><?php echo $discount_percentage . '% ছাড়' ?></span>
                                        <span class="regular-price"><?php echo $regular_price . ' টাকা' ?></span>
                                    <?php } else {
                                    ?>
                                        <span class="regular-price only-price"><?php echo $regular_price . ' টাকা' ?></span>
                                    <?php
                                    } ?>
                                </div>
                                            ...
                                            <div class="product-desc">
                                                ...
                                                <div class="product-bottom">
                                                    <ul class="specification">
                                                        ...
                                                        <li><span>প্রকাশক</span> <span class="right bangla_fn">
