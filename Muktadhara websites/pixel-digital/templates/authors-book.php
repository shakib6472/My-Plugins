<?php 
    ...
    $args = array(
        ...
        'meta_query'     => array(
            array(
                'key'     => '_book_author_id', // Replace with your actual meta key
                'value'   => $writes_id, // Replace with the specific value you're looking for
                'compare' => '=', // Use '=' to check for an exact match
            ),
        ),
                        ...
                        <div class="product_single" style="height: auto;">
                            ...
                            <div class="product_info">
                                <div class="product_content_same_height_last_sold">
                                    ...
                                    <h3><a href="<?php echo $author_url;  ?>"></a><?php echo esc_html($author_title); ?></h3>
                                    <h4>
                                        <?php if (!empty($sale_price)) { ?>
