<?php
class Elementor_hearing_test_single_posts extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'ht-single-posts';
    }

    public function get_title()
    {
        return esc_html__('HT Single Posts', 'hearing_test');
    }
...
?>
        ...
        $args = array(
            ...
            'p'         => $post_id, // Query by the current post ID
        );
...
<!--                             <p class="total-points m-0">Your Total Point: <span class="total-point">50</span></p> -->
                    ...
                    <div class="row mt-3 w-100 d-flex flex-colum justify-content-between">
                        ...
                        <div class="all w-50"> <a href="<?php echo home_url('all-questions/'); ?>"><div class="btn btn-success">All Questions List</div></a></div>
                        
                       <div class="pagination d-flex justify-content-end"> 
                       <?php
                        $prev_post = get_previous_post();
                        if (!empty($prev_post)) {
                            echo '<a href="' . get_permalink($prev_post->ID) . '" class="btn btn-primary me-3">Previous</a>';
                        }
                        
                        $next_post = get_next_post();
                        if (!empty($next_post)) {
                            echo '<a href="' . get_permalink($next_post->ID) . '" class="btn btn-primary">Next</a>';
                        }
                        ?>
